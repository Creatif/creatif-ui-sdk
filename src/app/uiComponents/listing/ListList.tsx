...
import ActionSection from '@app/uiComponents/listing/list/ActionSection';
import DeleteModal from '@app/uiComponents/listing/list/DeleteModal';
import MainListView from '@app/uiComponents/listing/list/MainListView';
import NothingFound from '@app/uiComponents/listing/list/NothingFound';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import styles from '@app/uiComponents/listing/list/css/ListTable.module.css';
import MainTableView from '@app/uiComponents/listing/table/MainTableView';
